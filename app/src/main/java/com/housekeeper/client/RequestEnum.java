...
public class RequestEnum {
    ...
    public static RequestModel getRequest(String id) {
        if (null == requestMap) {
            ...
            requestMap.put(USER_LANDLORD_TOPIMG, new RequestModel(USER_LANDLORD_TOPIMG, Constants.HOST_IP_REQ + "/rpc/user/landlord/topimg.app"));
    ...
    public static final String USER_LANDLORD_TOPIMG = "USER_LANDLORD_TOPIMG"; // 房东下载页面
